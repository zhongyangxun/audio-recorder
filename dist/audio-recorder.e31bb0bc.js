...
},{"./bundle-url":"C:/Users/Administrator/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"index.scss":[function(require,module,exports) {
...
var wavesurfer; // WaveSurfer object depends on WaveSurfer.js(https://wavesurfer-js.org/).

var objectURL;
var context; // Audio context instance(in Safari).

var processor; // ScriptProcessorNode instance to process audio(in Safari).
...
function initWaveSurfer() {
  ...
  wavesurfer = WaveSurfer.create({
    ...
    plugins: [// Using microphone plugin to create wave when recording.
...
function enableDownload(blob) {
  ...
  var fileName = new Date().toLocaleString() + 'mp3';
  downloadLinkEl.href = URL.createObjectURL(blob);
  downloadLinkEl.download = fileName;
  downloadButton.disabled = false;
}
},{"./index.scss":"index.scss"}],"C:/Users/Administrator/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
